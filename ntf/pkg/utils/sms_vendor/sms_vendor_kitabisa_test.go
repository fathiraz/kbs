...
func TestNewSmsVendorKitabisa(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := NewSmsVendorKitabisa(tt.args.config)
			if (err != nil) != tt.wantErr {
				t.Errorf("NewSmsVendorKitabisa() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
		})
	}
...
func Test_smsVendorKitabisaImplementation_Send(t *testing.T) {
	type fields struct {
		name       string
		url        string
		endpoint   string
	...
	tests := []struct {
	...
	}{
		{
			...
			args:       args{},
			wantResult: SmsVendorKitabisaResponse{},
			wantErr:    nil,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			f := &smsVendorKitabisaImplementation{
				name:       tt.fields.name,
				url:        tt.fields.url,
...
func Test_smsVendorKitabisaImplementation_Toggle(t *testing.T) {
	type fields struct {
		name       string
		url        string
		endpoint   string
...
func Test_smsVendorKitabisaImplementation_Data(t *testing.T) {
	type fields struct {
		name       string
		url        string
		endpoint   string
