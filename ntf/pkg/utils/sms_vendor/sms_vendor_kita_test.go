...
func TestNewSmsVendorKita(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := NewSmsVendorKita(tt.args.config)
			if (err != nil) != tt.wantErr {
				t.Errorf("NewSmsVendorKita() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
		})
	}
...
func Test_smsVendorKitaImplementation_Send(t *testing.T) {
	type fields struct {
		name       string
		url        string
		endpoint   string
	...
	tests := []struct {
	...
	}{
		{
			...
			args:       args{},
			wantResult: SmsVendorKitaResponse{},
			wantErr:    nil,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			f := &smsVendorKitaImplementation{
				name:       tt.fields.name,
				url:        tt.fields.url,
...
func Test_smsVendorKitaImplementation_Toggle(t *testing.T) {
	type fields struct {
		name       string
		url        string
		endpoint   string
...
func Test_smsVendorKitaImplementation_Data(t *testing.T) {
	type fields struct {
		name       string
		url        string
		endpoint   string
